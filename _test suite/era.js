 ...
 * @memo <code>
 ...
 TODO:
 視覺化互動式史地資訊平臺:整合 GIS + 視覺化年表 (e.g., HuTime)
 當年年度/每月資訊
 殘曆定年：允許前後一、二日誤差
 ...
 台灣地方志寶鑑 http://140.112.30.230/Fangjr/	建置者 李鈺淳 鳥瞰臺灣方志:以物產、職官為初探對象
...
function show_calendar(era_name) {
	...
	era_caption = era_caption ? [ '📅', {
		...
		T : [ dates.type ? '共有 %1 個時段{{PLURAL:%1|紀錄}}'
		// gettext_config:{"id":"total-$1-year-records"}
		: '共有 %1 個年段{{PLURAL:%1|紀錄}}', dates.length ]
	}, ')' ]
	//
	: [ {
...
function affairs() {
	...
	var place_nodes = [ '🗺️', {
		...
		臺灣 : {
			臺北市 : '25°2′N 121°38′E',
			桃園市 : '24°59′28.6″N 121°18′51.58″E',
			臺中市 : '24°15′N 120°40′E',
			臺南市 : '22°59′0″N 120°11′0″E',
			高雄市 : '22°38′0″N 120°16′0″E'
		},
		中國 : {
