...
function test_era() {
	...
	error_count += CeL.test('紀年/曆數', [
		...
		[['260年6月26日 2', '魏元帝景元元年6月1日'.to_Date('era').format({parser:'CE',format:'%Y年%m月%d日 %w'})]],
		[['260年6月26日 二', '元帝景元元年6月1日'.to_Date('era').format({parser:'CE',format:'%Y年%m月%d日 %a'})]],
		[['260年6月26日 星期二', '景元元年6月1日'.to_Date('era').format({parser:'CE',format:'%Y年%m月%d日 %A'})]],
