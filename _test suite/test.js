...
function test_era() {
	...
	all_error_count += CeL.test('.共存紀年 test: 可能需要因添加紀年而改變。', [
		...
		[CeL.era('延熙1年5月2日').共存紀年.join('|').covers('弥生時代神功皇后38年5月3日|高句麗東川王12年6月3日|新羅助賁尼師今9年6月3日|吳大帝嘉禾7年5月3日|百濟古尒王5年6月3日|魏明帝景初2年6月3日|東漢燕王紹漢2年6月3日'), '各特殊紀年→統一時間標準（中→西）：查詢某朝代/君主(帝王)所有的共存紀年與資訊。#1'],
