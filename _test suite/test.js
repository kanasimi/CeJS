...
function test_wiki() {
	...
	error_count += CeL.test('wiki: file_pattern & parse_template', [
		...
		[[',{{temp2,p{a}r}}', CeL.wiki.parse.template('a{{temp|{{temp2|p{a}r}}}}b', '', false)[2].join()], '未指定模板名，解析 parameters'],
		[['|{{temp2|p{a}r}}', CeL.wiki.parse.template('a{{temp|{{temp2|p{a}r}}}}b', 'temp', true)[2]], '指定模板名，不解析 parameters'],
		[[',{{temp2,p{a}r}}', CeL.wiki.parse.template('a{{temp|{{temp2|p{a}r}}}}b', 'temp', false)[2].join()], '未指定模板名，解析 parameters'],
		[['|p{a}r', CeL.wiki.parse.template('a{{temp|{{temp2|p{a}r}}}}b', 'temp2', true)[2]], '指定內部模板名，不解析 parameters'],
		[[',p{a}r', CeL.wiki.parse.template('a{{temp|{{temp2|p{a}r}}}}b', 'temp2', false)[2].join()], '指定內部模板名，解析 parameters'],
