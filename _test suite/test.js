...
function test_wiki() {
	...
	error_count += CeL.test('CeL.wiki.parser', function(assert) {
		...
		assert([ '{{c|d[[e]]f}}', CeL.wiki.parser(wikitext).parse()[0][2][1].toString() ]);
		wikitext = '{{c|d[[e]]f}}';
		...
		wikitext = 'a[[link#section]]b';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		wikitext = 'a[[link#section|displayed]]b';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		wikitext = 'a[[link#section|displayed|2]]b';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		wikitext = 'a[[link#section|displayed|2#3]]b';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		wikitext = 'a[[link#section#2|displayed|2#3]]b';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		wikitext = 'a[[#section#2|displayed|2#3]]b';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		wikitext = 'a[[text{abc}[[link]]text]]b';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		wikitext = 'a[[file:abc.jpg]]b';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		wikitext = 'a[[WP:abc]]b';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		wikitext = 'a[[:file:abc.jpg]]b';
		...
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		wikitext = '<nowiki>-{ </nowiki> a <nowiki>}-</nowiki>';
		assert([ '<nowiki>-{ </nowiki>', CeL.wiki.parser(wikitext).parse()[0].toString() ]);
		wikitext = '-{ <nowiki>dd}-<b></nowiki> }-<nowiki> ff</b></nowiki>';
		assert([ '-{ <nowiki>dd}-<b></nowiki> }-', CeL.wiki.parser(wikitext).parse()[0].toString() ]);
		...
		wikitext = '-{zh-cn:2 ;  zh-tw: 阿  }-';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		assert([ '阿', CeL.wiki.parse(wikitext).converted ]);
		wikitext = '-{zh-cn:2 ;  zh-tw: 阿  ;  }-';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		assert([ '阿  ', CeL.wiki.parse(wikitext).converted ]);
		wikitext = '-{ "ee" [[dd]]  ;zh-hk:阿;- ;zh-tw:1亞1;zh-cn:阿2 ;  zh-tw: 亞;;}-';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		assert([ '亞;', CeL.wiki.parse(wikitext).conversion['zh-tw'] ]);
		wikitext = '-{;  zh-hk:阿;- ;zh-tw:1亞1;zh-cn:阿2  ; zh-cn:阿3 ;  zh-tw: 2亞   ;  	 }-';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		// 顯示的時候，兩個以上的結尾空格會轉換成 " &nbsp;"。
		assert([ '2亞   ', CeL.wiki.parse(wikitext).conversion['zh-tw'] ]);
		wikitext = '-{  zh-tw:1;  zh-cn:2 ;}--{}--{  }--{;zh-tw:1;zh-cn:2}--{zh-tw:1;  zh-cn:2 ;  }-a[[t#a3| s[r]-{  ;  zh-hk:阿;- ;zh-tw:亞;zh-cn:阿2 ;  zh-tw:  亞姆----; ddff;;-ees: ggfggf;;}- ]]b';
		assert([ wikitext, CeL.wiki.parser(wikitext).parse().toString() ]);
		...
		// [[n:zh:Special:Permalink/120731]]
		wikitext = " <> >< <title> '''<沙盒>'''  ''ii'' <i>iii</i> <b>bbb</b>   [[File:YesCheck_BlueLinear.svg|20px]]  & &amp; &amp;amp; \"quot\" &quot; &amp;quot; 'apos' '&apos;apos '&apos; &amp;apos; <nowiki>  & &amp; &amp;amp; \"quot\" &quot; &amp;quot; 'apos' '&apos;apos '&apos; &amp;apos;  '''bbb''' <b>bbb</b> <i>iii</i> <ref /> {{VOA}} {{tl|VOA}}</nowiki> '''[[abc]]'''  <b>[[w:abc]]</b>  '''<i>[[w :  123   #  cba]]</i>''' [[ABC|ab'c]] [[ABC|ab''c'']] __NOINDEX__ ____  ___ __ __  _ {{tl|VOA}} [[template:VOA]] [https://zh.wikipedia.org zh''wiki''] __TOC__ -{}- C-{章}-D A-{  節  }-B  '''<nowiki>''< nowiki>''</nowiki>'''  <span style=\"color:green\">green</span> ";
		assert([ "[[#&#60;> >&#60; &#60;title> &#60;沙盒> ii iii bbb &amp; &amp; &amp;amp; \"quot\" \" &amp;quot; 'apos' ''apos '' &amp;apos; &amp; &amp; &amp;amp; \"quot\" \" &amp;quot; 'apos' ''apos '' &amp;apos; '''bbb''' &#60;b>bbb&#60;/b> &#60;i>iii&#60;/i> &#60;ref /> &#123;&#123;VOA&#125;&#125; &#123;&#123;tl&#124;VOA&#125;&#125; abc w:abc w : 123 # cba ab'c abc &#123;&#123;VOA&#125;&#125; template:VOA zhwiki -&#123;&#125;- C-&#123;章&#125;-D A-&#123; 節 &#125;-B ''&#60; nowiki>'' green|&#60;> >&#60; &#60;title> &#60;沙盒> ii iii bbb &amp; &amp; &amp;amp; &quot;quot&quot; &quot; &amp;quot; &apos;apos&apos; &apos;&apos;apos &apos;&apos; &amp;apos; &amp; &amp; &amp;amp; &quot;quot&quot; &quot; &amp;quot; &apos;apos&apos; &apos;&apos;apos &apos;&apos; &amp;apos; &apos;&apos;&apos;bbb&apos;&apos;&apos; &#60;b>bbb&#60;/b> &#60;i>iii&#60;/i> &#60;ref /> &#123;&#123;VOA&#125;&#125; &#123;&#123;tl&#124;VOA&#125;&#125; abc w:abc w : 123 # cba ab&apos;c abc ____ ___ __ __ _ &#123;&#123;VOA&#125;&#125; template:VOA zhwiki C章D A 節 B &apos;&apos;&#60; nowiki>&apos;&apos; green]]", CeL.wiki.section_link(wikitext).toString() ], 'wiki.section_link #1-1');
	});
